...
class Connection extends AbstractConnection
{
    ...
    public function setConnectionParameters(array $connectionParameters)
    {
        ...
        if (isset($connectionParameters['dsn'])) {
            $this->driverName = substr(
                    $connectionParameters['dsn'], 0, strpos($connectionParameters['dsn'], ':')
            );
        }
        ...
        elseif (isset($connectionParameters['driver'])) {
            $this->driverName = strtolower(substr(
                            str_replace(array('-', '_', ' '), '', $connectionParameters['driver']), 3
            ));
        }
    }
    ...
    public function connect()
    {
        ...
        elseif (!isset($dsn)) {
            ...
            'A dsn was not provided or could not be constructed from your parameters', $this->connectionParameters
            );
        }
